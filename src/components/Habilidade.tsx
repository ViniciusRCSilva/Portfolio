...
export default function Habilidade(props: HabilidadeProps) {
    return(
        <div className="flex justify-center">
            <div className={`flex flex-col w-20 h-20 md:w-40 md:h-40 bg-[#131321] items-center justify-center gap-3  hover:border-[#FF6600] border-b-2 border-r-2 border-transparent rounded-xl transition-all`}>
